...
var tbl_data = [
    ...
    {
        name: "receiveVideoSendMousePoints-android-v1",
        desc: "Able to <strong>receive video and send mouse points</strong> to-fro the client.",
        link: "/webrtc/rcvVidMouse-android.html"
    }
];
